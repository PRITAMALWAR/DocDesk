    ...
    <div>
      ...
      <section className="bg-white border-b">
        <div className="container py-12 grid md:grid-cols-2 gap-6 items-center">
          ...
          <div className="h-52 md:h-64 rounded-lg overflow-hidden shadow">
            <img src="https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?q=80&w=1200&auto=format&fit=crop" alt="seamless" className="w-full h-full object-cover"/>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white">
        <div className="container py-16 grid md:grid-cols-2 items-center gap-8">
          <div className="h-56 md:h-72 rounded-xl overflow-hidden shadow ring-1 ring-black/5">
            <img src="https://images.unsplash.com/photo-1584982751601-97dcc096659c?q=80&w=1400&auto=format&fit=crop" alt="book-visit" className="w-full h-full object-cover"/>
          </div>
          <div>
